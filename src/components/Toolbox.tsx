...
const DisassemblyStationIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <polygon points="4,10 20,6 20,18 4,14" fill="#FFF3E0" />
  </svg>
);
...
export default function Toolbox() {
  ...
  const isDisassemblyActive = deviceTypeToAdd === 'disassembly_station';
  ...
  return (
    <div className="toolbox">
      ...
      <div className="toolbox-group">
        <button
          className={`toolbox-button ${isDisassemblyActive ? 'active' : ''}`}
          onClick={() => { setToolMode('device'); setDeviceTypeToAdd('disassembly_station'); }}
          title="创建拆解站"
        >
          <DisassemblyStationIcon />
        </button>
      </div>
