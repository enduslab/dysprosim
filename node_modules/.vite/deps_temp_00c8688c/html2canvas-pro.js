  ...
  if (is_absolute) {
    ...
    const extractComponent = (color2, token) => {
      ...
      if (isIdentToken(token)) {
        const position2 = posFromVal(token.value);
...
var DocumentCloner = class {
  ...
  toIFrame(ownerDocument, windowSize) {
    ...
    try {
      const ownerWindow = (_a2 = this.referenceElement.ownerDocument) == null ? void 0 : _a2.defaultView;
      const trustedTypesFactory = ownerWindow && ownerWindow.trustedTypes;
      let policy = (_b2 = trustedTypesFactory == null ? void 0 : trustedTypesFactory.getPolicy) == null ? void 0 : _b2.call(trustedTypesFactory, "html2canvas-pro");
      ...
      if (clonedCtx) {
        if (!this.options.allowTaint && ctx) {
          ...
          if (gl) {
            ...
            if ((attribs == null ? void 0 : attribs.preserveDrawingBuffer) === false) {
...
var addBase = (targetELement, baseUri) => {
  ...
  headEle == null ? void 0 : headEle.insertBefore(baseNode, (headEle == null ? void 0 : headEle.firstChild) ?? null);
};
...
var TextRenderer = class {
   ...
   * implementation.
   */
  iterateLettersWithLetterSpacing(text, letterSpacing2, baseline, renderFn) {
   ...
   */
  renderTextWithLetterSpacing(text, letterSpacing2, baseline) {
    if (letterSpacing2 === 0) {
      this.ctx.fillText(text.text, text.bounds.left, text.bounds.top + baseline);
    } else {
      this.iterateLettersWithLetterSpacing(text, letterSpacing2, baseline, (letter, x, y) => {
    ...
    text.textBounds.forEach((text2) => {
      paintOrder2.forEach((paintOrderLayer) => {
        switch (paintOrderLayer) {
          case 0: {
            this.ctx.fillStyle = asString(styles.color);
            this.renderTextWithLetterSpacing(text2, styles.letterSpacing, styles.fontSize.number);
            const textShadows = styles.textShadow;
          ...
          case 1: {
            if (styles.webkitTextStrokeWidth && text2.text.trim().length) {
              ...
              if (styles.letterSpacing === 0) {
                ...
                this.iterateLettersWithLetterSpacing(text2, styles.letterSpacing, baseline, (letter, x, y) => this.ctx.strokeText(letter, x, y));
              }
              this.ctx.strokeStyle = "";
              this.ctx.lineWidth = 0;
              this.ctx.lineJoin = "miter";
...
var CanvasRenderer = class _CanvasRenderer extends Renderer {
  ...
  async renderNodeContent(paint) {
    ...
    if (isTextInputElement(container) && container.value.length) {
      ...
      this.ctx.clip();
      this.textRenderer.renderTextWithLetterSpacing(new TextBounds(container.value, textBounds2), styles.letterSpacing, baseline);
      this.ctx.restore();
      this.ctx.textBaseline = "alphabetic";
      this.ctx.textAlign = "left";
    }
...
var PerformanceMonitor = class {
  ...
  start(name, metadata) {
    ...
    if (this.activeMetrics.has(name)) {
      (_a2 = this.context) == null ? void 0 : _a2.logger.warn(`Performance metric '${name}' already started. Overwriting.`);
    }
   ...
   */
    ...
    if (!metric) {
      (_a2 = this.context) == null ? void 0 : _a2.logger.warn(`Performance metric '${name}' not found. Was start() called?`);
      return void 0;
    }
    ...
    (_b2 = this.context) == null ? void 0 : _b2.logger.debug(`⏱️  ${name}: ${metric.duration.toFixed(2)}ms`, metric.metadata);
    return metric;
  }
  /**
